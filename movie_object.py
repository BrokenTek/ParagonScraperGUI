'''
	...
	Purpose: This is a class that will create an object out of each movie scraped
	from Paragons movie times. This is a data holding class with simple getters for
	testing and a str method for output.
'''
class Movie(object):
